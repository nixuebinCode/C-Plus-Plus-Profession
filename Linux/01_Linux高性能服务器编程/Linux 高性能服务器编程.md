...
考虑用 IP 数据报封装一个长度为 1481 字节的 ICMP 报文（包括 8 字节的 ICMP 头部，所以其数据部分长度为 1473 字节），则该数据报在使用以太网帧传输时必须被分片：
 ...
 ![image-20221110103058511](images/image-20221110103058511.png)
...
### 2.4.1 IP 模块工作流程
 ...
 ![image-20221110103659710](images/image-20221110103659710.png)
...
ICMP 重定向报文格式如图所示：
 ...
 ![image-20221110111616885](images/image-20221110111616885.png)
...
* 应该使用的路由器的IP 地址。
 ...
 ![image-20221110115355053](images/image-20221110115355053.png)